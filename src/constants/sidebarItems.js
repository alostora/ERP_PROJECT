          ...
          handleSidebarItems() {
               ...
               if (this.company_id && !this.branch_id) {
                    const companyManagement = {
                         ...
                         icon: "pi pi-building",
                         items: [
                              { label: "common.menu.companyDetails", icon: "pi pi-circle-fill", path: `/company/${this.company_id}` },
                              ...
                              // Business Operations Subgroup
                              {
                                   ...
                                   icon: "pi pi-briefcase",
                                   items: [
                                        { label: "common.menu.contacts", icon: "pi pi-circle-fill", path: `/company/${this.company_id}/contacts` },
                                        { label: "common.menu.branches", icon: "pi pi-circle-fill", path: `/company/${this.company_id}/branches` },
                                        { label: "common.menu.employees", icon: "pi pi-circle-fill", path: `/company/${this.company_id}/employees` },
                                   ]
                              },
                              ...
                              // Financial Subgroup
                              {
                                   ...
                                   icon: "pi pi-dollar",
                                   items: [
                                        { label: "common.menu.invoiceStages", icon: "pi pi-circle-fill", path: `/company/${this.company_id}/invoice-stages` },
                                        { label: "common.menu.taxes", icon: "pi pi-circle-fill", path: `/company/${this.company_id}/taxes` },
                                        { label: "common.menu.discounts", icon: "pi pi-circle-fill", path: `/company/${this.company_id}/discounts` },
                                   ]
                              },
                         ]
                    }
                    ...
                    const companiesIndex = this.sidebar_items.findIndex(item => item.label === "common.menu.companiesGroup")
                    if (companiesIndex !== -1) {
               ...
               if (this.branch_id && this.company_id) {
                    const branchManagement = {
                         ...
                         items: [
                              { label: "common.menu.branchDetails", icon: "pi pi-circle-fill", path: `/branch/${this.company_id}/show/${this.branch_id}` },
                              { label: "common.menu.warehouses", icon: "pi pi-circle-fill", path: `/branch/${this.company_id}/warehouses/${this.branch_id}` },
                              { label: "common.menu.branchEmployees", icon: "pi pi-circle-fill", path: `/branch/${this.company_id}/employees/${this.branch_id}` },
                              { label: "common.menu.purchasesInvoices", icon: "pi pi-circle-fill", path: `/branch/${this.company_id}/purchases-invoices/${this.branch_id}` },
                              { label: "common.menu.backToList", icon: "pi pi-arrow-left", path: `/company/${this.company_id}/branches` },
                         ]
                    }
