    ...
    <form v-else @submit.prevent="emitSubmit">
      <div class="zoom-out">
        ...
        <div class="row mb-3">
          <div class="col-12">
            <div class="card-info">
              <div class="card-header-info">{{ $t('salesInvoicesReturns.base_info') }}</div>
              <div class="card-body">
                <!-- Row 1: Name -->
                <div class="row">
                  <div class="col-6">
                      ...
                      <Fluid>
                        <FloatLabel variant="on">
                          <InputText
                            ...
                            class="w-full"
                          />
                          <label for="invoice_name">{{ $t('salesInvoicesReturns.name') }}</label>
                        </FloatLabel>
                      </Fluid>
                    </div>
                  ...
                  <div class="col-6">
                    <div class="form-group">
                      <Select
                        ...
                        :filter="true"
                        :showClear="true"
                        :placeholder="$t('common.select') + ' ' + $t('salesInvoicesReturns.branch')"
                  ...
                  <div class="col-6">
                    <div class="form-group">
                      <Select
                        ...
                        :showClear="true"
                        :placeholder="
                          $t('common.select') + ' ' + $t('salesInvoicesReturns.payment_types')
                        "
                        :filterPlaceholder="$t('common.search')"
                        class="w-full"
                      />
          ...
          <div class="col-12">
            <div class="card-indigo">
              <div class="card-header-indigo">
                {{ $t('salesInvoicesReturns.final_products') + '( ' + final_products.length + ')' }}
              </div>
              <div class="card-body">
                <div class="row">
                  <ScrollPanel
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="row g-2 mb-3">
                        ...
                        <div class="col-6">
                          <Select
                            ...
                            optionValue="id"
                            :placeholder="$t('salesInvoicesReturns.measurement_unit')"
                            :filter="true"
                            class="w-full"
                          >
                            ...
                            <template #value="slotProps">
                              ...
                              <span v-else>{{ $t('salesInvoicesReturns.measurement_unit') }}</span>
                            </template>
                          </Select>
                        </div>
                        <div class="col-6">
                        ...
                        <template #header>
                          <div class="flex items-center gap-2">
                            ...
                            <span class="font-medium text-warning text-sm">
                              {{ $t('salesInvoicesReturns.operations') }}
                            </span>
                            <span
                          ...
                          >
                              ...
                              <Fluid>
                                <FloatLabel variant="on">
                                  ...
                                  <label :for="'product_operation__name_' + operationsIndex">
                                    {{ $t('salesInvoicesReturns.name') }}
                                  </label>
                                </FloatLabel>
                                <small
                                  v-if="
                                    errors[
                                      `final_products.${index}.operations.${operationsIndex}.name`
                                    ]
                                  "
                                  class="error-message"
                                >
                              ...
                              <Fluid>
                                <FloatLabel variant="on">
                                  ...
                                  <label :for="'product_operation_price_' + operationsIndex">
                                    {{ $t('salesInvoicesReturns.price') }}
                                  </label>
                                </FloatLabel>
                                <small
                                  v-if="
                                    errors[
                                      `final_products.${index}.operations.${operationsIndex}.price`
                                    ]
                                  "
                                  class="error-message"
                                >
                            ...
                            <div class="col-10">
                              <textarea
                                ...
                                class="textarea"
                                rows="3"
                                :placeholder="$t('salesInvoicesReturns.details')"
                              >
                              </textarea>
                              <small
                                v-if="
                          ...
                          <div class="bg-warning-50 border-l-4 border-warning rounded p-2 mt-3">
                            <div class="flex justify-between">
                              <span class="text-warning font-medium text-sm">
                                {{ $t('salesInvoicesReturns.total_operations_cost') }}:
                              </span>
                      ...
                      <div class="bg-gray-50 border-l-4 border-gray rounded p-2 mb-3">
                        <div class="flex justify-between">
                          <span class="text-warning font-medium text-sm">
                            {{ $t('salesInvoicesReturns.total_price') }}:
                          </span>
                          <span class="font-semibold text-warning text-sm">
                      ...
                      <div class="bg-gray-50 border-l-4 border-gray rounded p-2">
                        <div class="flex justify-between">
                          <span class="text-warning font-medium text-sm">
                            {{ $t('salesInvoicesReturns.total_price_plus_operations') }}:
                          </span>
          ...
          <div class="col-12">
            <div class="card-info">
              <div class="card-header-info">
                {{ $t('salesInvoicesReturns.additional_costs') }}
              </div>
              <div class="card-body">
                <div class="flex justify-end mb-2">
                  <Button
                ...
                >
                  <div class="col-5">
                    ...
                    <small v-if="errors[`additional_costs.${index}.name`]" class="error-message">
                      {{ errors[`additional_costs.${index}.name`] }}
                    </small>
                  </div>
                  <div class="col-5">
                    <Fluid>
                      <FloatLabel variant="on">
                        ...
                        <label for="'additional_cost_value_' + index">{{
                          $t('salesInvoicesReturns.value')
                        }}</label>
                      </FloatLabel>
                    </Fluid>
                    <small v-if="errors[`additional_costs.${index}.value`]" class="error-message">
                      {{ errors[`additional_costs.${index}.value`] }}
                    </small>
                  </div>
                  <div class="col-2 text-right">
                    <Button
                ...
                <div class="border border-warning-200 rounded p-2 bg-warning-50">
                  <div class="flex justify-between">
                    <span class="text-warning font-medium"
                      >{{ $t('salesInvoicesReturns.total_additional_costs') }}:</span
                    >
          ...
          <div class="col-12">
            <div class="card-success">
              <div class="card-header-success">
                {{ $t('salesInvoicesReturns.additional_discounts') }}
              </div>
              ...
              <div class="card-body">
                ...
                >
                  <div class="col-5">
                    ...
                    <small
                      v-if="errors[`additional_discounts.${index}.name`]"
                      class="error-message"
                    >
                      {{ errors[`additional_discounts.${index}.name`] }}
                    </small>
                  </div>
                  <div class="col-5">
                    <Fluid>
                    ...
                    <small
                      v-if="errors[`additional_discounts.${index}.value`]"
                      class="error-message"
                    >
                      {{ errors[`additional_discounts.${index}.value`] }}
                    </small>
                  </div>
                  <div class="col-2 text-right">
                    <Button
                ...
                <div class="border border-warning-200 rounded p-2 bg-warning-50">
                  <div class="flex justify-between">
                    <span class="text-warning font-medium"
                      >{{ $t('salesInvoicesReturns.total_additional_discounts') }}:</span
                    >
                    <span class="font-semibold text-warning">{{
        ...
        <div v-if="final_products.length" class="row mt-2">
          <div class="col-12">
            <div class="card-info">
              <div class="card-header-info">{{ $t('salesInvoicesReturns.total_summary') }}</div>

              <div class="card-body">
                <div class="flex justify-between mb-2">
                  <span class="text-secondary">{{ $t('salesInvoicesReturns.subtotal') }}:</span>
                ...
                <div class="flex justify-between pt-2 border-t border-primary-200">
                  <span class="font-bold text-primary"
                    >{{ $t('salesInvoicesReturns.grand_total') }}:</span
                  >
...
export default {
  ...
  watch: {
    sales_invoice_id: {
      handler(newVal) {
        this.localFormData.sales_invoice_id = newVal
      },
      immediate: true,
    },
    company_id: {
  ...
  methods: {
    ...
    decrementQuantity(product) {
      if (product.quantity > 1 && product.quantity > product.operations.length) {
        product.quantity -= 1
      }
    },
