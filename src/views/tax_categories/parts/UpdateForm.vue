<template>
  <Dialog
    ...
    :header="$t('common.updateTitle', { module: $t('taxCategories.title') })"
    :modal="true"
    :style="{ width: '500px' }"
    @hide="closeFormModal"
  >
    <form @submit.prevent="handleSubmit">
      ...
      <div class="form-group">
        <label class="form-label required">{{ $t('taxCategories.details') }}</label>
        <input
      ...
      <div class="form-group">
        <label class="form-label required">{{ $t('taxCategories.details_ar') }}</label>
        <input
