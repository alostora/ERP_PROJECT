  ...
  <div class="page">
    ...
    <div class="card">
      ...
      >
        ...
        <Column field="name" :header="$t('cashBoxes.name')" sortable />

        <Column field="name_ar" :header="$t('cashBoxes.name_ar')" sortable />

        <Column field="balance" :header="$t('cashBoxes.balance')" sortable />
