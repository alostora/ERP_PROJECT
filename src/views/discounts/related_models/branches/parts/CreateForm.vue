<template>
  <Dialog
    ...
    :header="$t('discounts.createBranches', { module: $t('discounts.title') })"
    :modal="true"
    :style="{ width: '700px' }"
    @hide="closeFormModal"
  >
...
export default {
  ...
  data() {
    return {
      apiUrl: API_ROUTES.DISCOUNT_BRANCH.BASE,
      formData: {
  ...
  methods: {
    openModal() {
      ...
      this.loadBranches(this.company_id, this.formData.discount_id)
    },
