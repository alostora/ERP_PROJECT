<template>
  <Dialog
    ...
    :header="$t('common.createTitle', { module: $t('paymentEquityItems.title') })"
    :modal="true"
    :style="{ width: '500px' }"
    @hide="closeFormModal"
  >
        ...
        <div class="col-6">
          <div class="form-group">
            <FloatLabel variant="on">
              ...
              <label for="name">{{ $t('paymentEquityItems.name') }}</label>
            </FloatLabel>
          </div>
        ...
        <div class="col-6">
          <div class="form-group">
            <FloatLabel variant="on">
              ...
              <label for="name_ar">{{ $t('paymentEquityItems.name_ar') }}</label>
            </FloatLabel>
          </div>
          ...
          <div class="form-group">
            <FloatLabel variant="on">
              <Textarea
                ...
                fluid
              />
              <label for="details">{{ $t('paymentEquityItems.details') }}</label>
            </FloatLabel>
          </div>
          ...
          <div class="form-group">
            <FloatLabel variant="on">
              <Textarea
                ...
                fluid
              />
              <label for="details_ar">{{ $t('paymentEquityItems.details_ar') }}</label>
            </FloatLabel>
          </div>
...
export default {
  ...
  data() {
    return {
      apiUrl: API_ROUTES.PAYMENT_EQUITY_ITEM.BASE,
      formData: {
        company_id: '',
        name: '',
        name_ar: '',
