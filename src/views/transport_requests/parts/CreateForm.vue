  ...
  methods: {
    ...
    handelFormData(cartFormData) {
      this.formData = {
        ...
        from_branch_id: cartFormData.from_branch_id,
        to_branch_id: cartFormData.to_branch_id,
        from_warehouse_id: cartFormData.from_warehouse_id,
        to_warehouse_id: cartFormData.to_warehouse_id,
