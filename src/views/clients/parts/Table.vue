  ...
  <div class="page">
    ...
    <div class="card">
      ...
      <DataTable
        ...
        showGridlines
      >
        <Column field="id" :header="$t('clients.id')">
          <template #body="slotProps">
            <span class="font-mono text-sm">{{ slotProps.index + 1 }}</span>
          </template>
        </Column>

        <Column field="logo" :header="$t('clients.avatar')">
          <template #body="slotProps">
        ...
        <Column field="created_at" :header="$t('clients.createdAt')">
          <template #body="{ data }">
...
export default {
  ...
  data() {
    return {
      apiUrl: API_ROUTES.CLIENT.SEARCH,
      deleteUrl: API_ROUTES.CLIENT.BASE,
      item_id: '',
    }
  },
