    ...
    <form v-else @submit.prevent="emitSubmit">
      <div class="zoom-out">
          ...
          <div class="col-12">
            <div class="card-indigo">
              <div class="card-header-indigo">
                {{ $t('salesInvoices.final_products') + '( ' + final_products.length + ')' }}
              </div>
              <div class="card-body">
                <div class="row">
                  <ScrollPanel
                  ...
                  >
                    ...
                    >
                      ...
                      <div class="row g-2 mb-3">
                          ...
                          <Fluid>
                            <InputGroup>
                              ...
                              <FloatLabel variant="on">
                                ...
                                />
                                <label for="quantity">{{ $t('salesInvoices.quantity') }}</label>
                              </FloatLabel>
                              <InputGroupAddon>
                                <Button
                                  icon="pi pi-plus"
                        ...
                        <div class="col-6">
                          <Select
                            ...
                            optionValue="id"
                            :placeholder="$t('salesInvoices.measurement_unit')"
                            :filter="true"
                            class="w-full"
                          >
                            ...
                            <template #value="slotProps">
                              ...
                              <span v-else>{{ $t('salesInvoices.measurement_unit') }}</span>
                            </template>
                          </Select>
                        </div>
                        <div class="col-6">
                          ...
                          >
                            ...
                            <div class="col-10">
                              <textarea
                                ...
                                class="textarea"
                                rows="3"
                                :placeholder="$t('salesInvoices.details')"
                              >
                              </textarea>
                              <small
                                v-if="
                          ...
                          <div class="bg-warning-50 border-l-4 border-warning rounded p-2 mt-3">
                            <div class="flex justify-between">
                              <span class="text-warning font-medium text-sm">
                                {{ $t('salesInvoices.total_operations_cost') }}:
                              </span>
                      ...
                      <div class="bg-gray-50 border-l-4 border-gray rounded p-2">
                        <div class="flex justify-between">
                          <span class="text-warning font-medium text-sm">
                            {{ $t('salesInvoices.total_price_plus_operations') }}:
                          </span>
        ...
        <div v-if="final_products.length" class="row mt-2">
          <div class="col-12">
            <div class="card-info">
              <div class="card-header-info">{{ $t('salesInvoices.additional_costs') }}</div>
              <div class="card-body">
                <div class="flex justify-end mb-2">
                  <Button
                    icon="pi pi-plus"
                ...
                <div class="border border-warning-200 rounded p-2 bg-warning-50">
                  <div class="flex justify-between">
                    <span class="text-warning font-medium"
                      >{{ $t('salesInvoices.total_additional_costs') }}:</span
                    >
          ...
          <div class="col-12">
            <div class="card-success">
              <div class="card-header-success">
                {{ $t('salesInvoices.additional_discounts') }}
              </div>
              ...
              <div class="card-body">
                ...
                <div class="border border-warning-200 rounded p-2 bg-warning-50">
                  <div class="flex justify-between">
                    <span class="text-warning font-medium"
                      >{{ $t('salesInvoices.total_additional_discounts') }}:</span
                    >
                    <span class="font-semibold text-warning">{{
        ...
        <div v-if="final_products.length" class="row mt-2">
          <div class="col-12">
            <div class="card-info">
              <div class="card-header-info">{{ $t('salesInvoices.total_summary') }}</div>

              <div class="card-body">
                <div class="flex justify-between mb-2">
                  <span class="text-secondary">{{ $t('salesInvoices.subtotal') }}:</span>
                  <span class="font-medium">{{ formatCurrency(calculateSubtotal()) }}</span>
                </div>

                <div class="flex justify-between mb-2">
                  <span class="text-sm">{{ $t('salesInvoices.total_operations_cost') }}:</span>
                ...
                <div class="flex justify-between pt-2 border-t border-primary-200">
                  <span class="font-bold text-primary">{{ $t('salesInvoices.grand_total') }}:</span>
...
export default {
  ...
  data() {
    return {
      apiUrl: API_ROUTES.SALES_INVOICE.BASE,
      localFormData: {
        id: '',
