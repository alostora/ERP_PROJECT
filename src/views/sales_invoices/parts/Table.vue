<template>
  <div class="page">
    <div class="page-header">
      <h1 class="page-title">{{ $t('salesInvoices.title') }}</h1>
    ...
    <div class="card">
          ...
          <div class="col-12 col-md-6 col-lg-3">
            <div class="search-wrapper">
              <Select
                ...
                optionLabel="name"
                optionValue="value"
                :placeholder="$t('common.all') + ' ' + $t('salesInvoices.is_closed')"
                :filter="true"
                :showClear="true"
                :filterPlaceholder="$t('common.search')"
                class="w-full"
      ...
      <DataTable
        ...
        showGridlines
      >
        <Column field="id" :header="$t('salesInvoices.id')" class="col-1">
          <template #body="slotProps">
            <span class="font-mono text-sm">{{ slotProps.index + 1 }}</span>
          </template>
        </Column>

        <Column field="reference_code" :header="$t('salesInvoices.reference_code')" class="col-2" />

        <Column field="name" :header="$t('salesInvoices.name')" class="col-2" />
        ...
        <Column :header="$t('salesInvoices.is_closed')" class="col-1">
          <template #body="{ data }">
        ...
        <Column :header="$t('salesInvoices.contact')" class="col-1">
          <template #body="{ data }">
            {{ data.contact?.name || '-' }}
          </template>
        </Column>
        ...
        <Column
          ...
          :header="$t('salesInvoices.net_amount_after_costs_and_discounts')"
          class="col-1"
        />

        <Column :header="$t('salesInvoices.returns')">
          <template #body="{ data }">
            <button
            ...
            >
              ...
              {{ $t('salesInvoices.returns') }}
            </button>
          </template>
        </Column>

        <Column field="created_at" :header="$t('salesInvoices.createdAt')" class="col-1">
          <template #body="{ data }">
...
export default {
    ...
    '$route.params.company_id': {
      handler(newVal) {
        if (newVal && newVal !== 'undefined') {
          this.apiUrl = `${API_ROUTES.SALES_INVOICE.SEARCH}/${newVal}`
        }
      },
      immediate: true,
    },
  ...
  data() {
    return {
      apiUrl: API_ROUTES.SALES_INVOICE.SEARCH,
      deleteUrl: API_ROUTES.SALES_INVOICE.BASE,
