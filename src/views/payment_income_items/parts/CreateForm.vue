<template>
  <Dialog
    ...
    :header="$t('common.createTitle', { module: $t('paymentIncomeItems.title') })"
    :modal="true"
    :style="{ width: '500px' }"
    @hide="closeFormModal"
  >
        ...
        <div class="col-6">
          <div class="form-group">
            <FloatLabel variant="on">
              ...
              <label for="name">{{ $t('paymentIncomeItems.name') }}</label>
            </FloatLabel>
          </div>
        ...
        <div class="col-6">
          <div class="form-group">
            <FloatLabel variant="on">
              ...
              <label for="name_ar">{{ $t('paymentIncomeItems.name_ar') }}</label>
            </FloatLabel>
          </div>
          ...
          <div class="form-group">
            <FloatLabel variant="on">
              <Textarea
                ...
                fluid
              />
              <label for="details">{{ $t('paymentIncomeItems.details') }}</label>
            </FloatLabel>
          </div>
          ...
          <div class="form-group">
            <FloatLabel variant="on">
              <Textarea
                ...
                fluid
              />
              <label for="details_ar">{{ $t('paymentIncomeItems.details_ar') }}</label>
            </FloatLabel>
          </div>
...
export default {
  ...
  data() {
    return {
      apiUrl: API_ROUTES.PAYMENT_INCOME_ITEM.BASE,
      formData: {
        company_id: '',
        name: '',
        name_ar: '',
