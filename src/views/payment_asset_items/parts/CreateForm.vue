<template>
  <Dialog
    ...
    :header="$t('common.createTitle', { module: $t('paymentAssetItems.title') })"
    :modal="true"
    :style="{ width: '500px' }"
    @hide="closeFormModal"
  >
        ...
        <div class="col-6">
          <div class="form-group">
            <FloatLabel variant="on">
              ...
              <label for="name">{{ $t('paymentAssetItems.name') }}</label>
            </FloatLabel>
          </div>
        ...
        <div class="col-6">
          <div class="form-group">
            <FloatLabel variant="on">
              ...
              <label for="name_ar">{{ $t('paymentAssetItems.name_ar') }}</label>
            </FloatLabel>
          </div>
          ...
          <div class="form-group">
            <FloatLabel variant="on">
              <Textarea
                ...
                fluid
              />
              <label for="details">{{ $t('paymentAssetItems.details') }}</label>
            </FloatLabel>
          </div>
          ...
          <div class="form-group">
            <FloatLabel variant="on">
              <Textarea
                ...
                fluid
              />
              <label for="details_ar">{{ $t('paymentAssetItems.details_ar') }}</label>
            </FloatLabel>
          </div>
...
export default {
  ...
  data() {
    return {
      apiUrl: API_ROUTES.PAYMENT_ASSET_ITEM.BASE,
      formData: {
        company_id: '',
        name: '',
        name_ar: '',
